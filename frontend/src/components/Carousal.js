		...
		<div  className="carousel-inner">
			<div  className="carousel-item active">
				...
				<div  className="carousel-caption">
					...
					<p className="text-warning">Unlock boundless potential and foster intellectual growth through our immersive virtual experiences, designed to empower minds and cultivate a future of limitless possibilities.</p>
				</div>
			</div>
			<div  className="carousel-item">
				...
				<div  className="carousel-caption">
					...
					<p className="text-warning">Explore a compassionate journey to mental well-being with our experienced psychologists, dedicated to guiding you through life's challenges with empathy and expertise.</p>
				</div>
			</div>
			<div  className="carousel-item">
				...
				<div  className="carousel-caption">
					...
					<p className="text-warning">Discover a sanctuary for self-discovery and healing as our team of skilled psychologists provide personalized therapeutic solutions, fostering resilience and emotional well-being.</p>
