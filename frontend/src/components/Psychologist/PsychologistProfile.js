...
const PsychologistProfile = () => {
  ...
  const getUser = async (id) => {
    ...
    const response = await fetch(
      `http://localhost:5000/psychologist/get/${id}`,
      requestOptions
    );
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await fetch(
      `http://localhost:5000/psychologist/updatePsychologist/${id}`,
      requestOptions
    );
      ...
      >
        <div className="m-4 mb-5 conatiner shadow-lg  p-5">
          ...
          <form className="px-5 py-3 mx-3" onSubmit={handleSubmit}>
            ...
            <div className="mb-4 ">
              <label htmlFor="experiance" className="form-label fw-bold">
                Experiance :
              </label>
              <input
                required
