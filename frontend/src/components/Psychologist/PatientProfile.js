  ...
  return (
    <div className="main">
      <div className="main container-fluid bg-secondary p-5">
        <div className="container w-75 justify-content-center shadow-lg p-5 mt-3 bg-light rounded">
          <h1 className="text-warning text-center pb-4">Patient Profile</h1>
          ...
          <table className="table border table-bordered border-warning border-3 rounded table-striped ">
            <tbody>
              ...
              <tr>
                <th scope="row" className="flex-wrap">
                  Address:
                </th>
